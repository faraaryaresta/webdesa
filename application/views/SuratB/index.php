...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?= base_url() ?>SuratB" class="nav-link active" >
              <i class="nav-icon fas fa-th"></i>
              <p>
                Surat Online     
              </p>
  ...
  <a href="<?php echo base_url("lapSuratpdf.php"); ?>"><input type="button" style="background: red" value="Export PDF"></a><br><br>
    ...
    <table border="2" cellpadding="20">
      ...
      if( ! empty($surat)){ // Jika data userA tidak sama dengan kosong, artinya jika data userA ada
        foreach($surat as $data){
          ...
          <td>".$data->phone."</td>
          <td>".$data->pesan."</td>
          <td><a href='".base_url("suratB/hapus/".$data->nik)."'>Hapus</td>
          </tr>";
        }
