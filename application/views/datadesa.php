      ...
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-6 footer-links">
          ...
          <ul>
              ...
              <li><i class="bi bi-dash"></i> <a href="<?php echo base_url("datadesa")?>">Data Desa</a></li>
              <li><i class="bi bi-dash"></i> <a href="<?php echo base_url("berita")?>">Berita</a></li>
              <li><i class="bi bi-dash"></i> <a href="<?php echo base_url("profil")?>">Penduduk</a></li>
            </ul>
        </div>
