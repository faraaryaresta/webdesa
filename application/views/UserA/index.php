    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?= base_url() ?>userA" class="nav-link active">
...
<a href="<?php echo base_url("userA/tambah"); ?>"><input type="button" value="Tambah Data"></a>
  <a href="<?php echo base_url("exportuser.php"); ?>"><input type="button" style="background: green" value="Export Excel"></a>
  <a href="<?php echo base_url("lapUserpdf.php"); ?>"><input type="button" style="background: red" value="Export PDF"></a><br><br>
