...
<?php echo form_open("pendudukA/tambah", array('enctype'=>'multipart/form-data')); ?>
	<table cellpadding="8">
		<tr>
			<td>Nama</td>
		...
		<tr>
			<td>Gambar</td>
			<td><input type="file" name="input_penduduk" ></td>
		</tr>
	</table>
		
	<hr>
	<input type="submit" name="submit" value="Simpan">
	<a href="<?php echo base_url("pendudukA"); ?>"><input type="button" value="Batal"></a>
<?php echo form_close(); ?>
