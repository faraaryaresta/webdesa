...
<body class="page-services">
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="home.php" class="logo d-flex align-items-center">
        ...
        <img src="<?= base_url() ?>assets/img/lambang.jpg" class="img-fluid" alt="">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="<?php echo base_url("suratA")?>"class="active">Surat Online</a></li>
          <li><a href="<?php echo base_url("penduduk")?>">Penduduk</a></li>
          <li><a href="<?php echo base_url("gambar")?>">Berita</a></li>
  ...
  <p class="lead" class="text-center" >Silahkan lengkapi semua isian sesuai dengan data yang diperlukan</p>
<?php echo form_open("suratA/tambah"); ?>
      <table cellpadding="8">
        ...
        <tr>
          <td>Phone</td>
          <td><input type="text" name="input_phone" value="<?php echo set_value('input_phone'); ?>"></td>
        </tr>
        <tr>
          <td>Pesan</td>
          <td><textarea type="textarea" name="input_pesan" value="<?php echo set_value('input_pesan'); ?>"></textarea></td>
        </tr>
      </table>
      
      <hr>
      <input type="submit" name="submit" value="Simpan">
      <a href="<?php echo base_url('suratA'); ?>"><input type="button" value="Batal"></a>
    <?php echo form_close(); ?>
    <div style="color: #6799cf;"><?php echo validation_errors(); ?></div>
