...
$query = "SELECT * FROM penduduk ORDER BY username";
...
$judul = "LAPORAN DAFTAR PENDUDUK";
$header = array(
 array("label"=>"GAMBAR", "length"=>25, "align"=>"L"),
 array("label"=>"NAMA", "length"=>25,"align"=>"L"),
 array("label"=>"TANGGAL LAHIR", "length"=>50,"align"=>"L"),
